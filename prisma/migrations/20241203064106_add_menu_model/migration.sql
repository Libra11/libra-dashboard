...
-- AddForeignKey
ALTER TABLE "_MenuPermissions" ADD CONSTRAINT "_MenuPermissions_A_fkey" FOREIGN KEY ("A") REFERENCES "Menu"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MenuPermissions" ADD CONSTRAINT "_MenuPermissions_B_fkey" FOREIGN KEY ("B") REFERENCES "Permission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
